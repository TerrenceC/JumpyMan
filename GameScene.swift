...
class GameScene: SKScene, SKPhysicsContactDelegate, AVAudioPlayerDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        background.position = CGPointMake(screenWidth/2, screenHeight - background.size.height/2)
        background.zPosition = CGFloat.min
        background.runAction(SKAction.moveByX(-1, y: 0, duration: 1))
        ...
        //Setup score label
        scoreLabel.fontName = "DIN Condensed Bold"
        scoreLabel.text = "0"
        ...
        //Setup tap label
        tapNode.fontName = "DIN Condensed Bold"
        tapNode.text = "Tap!"
        tapNode.fontSize = 40
        ...
        endScoreLabel.fontName = "DIN Condensed Bold"
        ...
        endScoreLabel.position = CGPointMake(0, 40)
        
        highScoreLabel.fontName = "DIN Condensed Bold"
        ...
        highScoreLabel.position = CGPointMake(0, -40)
